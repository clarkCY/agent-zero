...
def get_default_settings() -> Settings:
    return Settings(
        ...
        chat_model_name="ollama/qwen2.5-coder:14b",
        ...
        util_model_name="ollama_chat/llama3.1",
        ...
        browser_model_name="ollama/llama3.2-vision:11b",
        browser_model_api_base="http://host.docker.internal:11434",
